    ...
    <section class="content">
      <div class="box box-success">
            <div class="box-header with-border">
              <h3 class="box-title">Grafik Luas Hutan</h3>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Tabel Luas Hutan</h3>
              <!-- <div class="box-tools">
                ...
                <tbody>
                  @foreach($luas_hutans as $luas_hutan)
                    <tr>
                      ...
                      <td>
                        <form action="/luas_hutan/{{$luas_hutan->id}}" method="post">
                          <a class="btn btn-round btn-info btn-xs" href="/luas_hutan/{{$luas_hutan->id}}/edit">Edit</a>
