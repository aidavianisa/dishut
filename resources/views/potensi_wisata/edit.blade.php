    ...
    <section class="content">
      <div class="box box-info">
         <div class="box-header with-border">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form action="/potensi_wisata/{{$potensi_wisata->id}}" method="post" class="form-horizontal">
              <div class="box-body">
                <div class="form-group">
                  <label class="col-sm-2 control-label">Nama Wisata</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" placeholder="Wisata" name="wisata" value="{{ $potensi_wisata->wisata }}">
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" placeholder="Masukkan Keterangan" name="keterangan" value="{{ $potensi_wisata->keterangan}}">
                  </div>
                </div>
              </div>
              <!-- /.box-body -->
