...
<!-- Content Header (Page header) -->
    <section class="content-header">
      ...
      <br>
      <button type="button" class="btn btn-primary btn-s" onclick="location.href='{{url('/taman_nasional/create')}}'">Tambah</button>
      <a href="{{ route('taman_nasional.excel') }}" class="btn btn-success btn-s">Export ke Excel</a>
    </section>
  <!-- Main content -->
    <section class="content">
      <div class="box box-success">
            <div class="box-header with-border">
              <h3 class="box-title">Grafik Luas Taman Nasional</h3>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Tabel Luas Taman Nasional</h3>
              <!-- <div class="box-tools">
                ...
                <tbody>
                  @foreach($luas_hutans as $luas_hutan)
                    <tr>
                      ...
                      <td>
                        <form action="/taman_nasional/{{$luas_hutan->id}}" method="post">
                          <a class="btn btn-round btn-info btn-xs" href="/taman_nasional/{{$luas_hutan->id}}/edit">Edit</a>
