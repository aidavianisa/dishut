...
<!-- Content Header (Page header) -->
    <section class="content-header">
      ...
      <br>
      <button type="button" class="btn btn-primary btn-s" onclick="location.href='{{url('/cagar_alam/create')}}'">Tambah</button>
      <a href="{{ route('cagar_alam.excel') }}" class="btn btn-success btn-s">Export ke Excel</a>
    </section>
  <!-- Main content -->
    <section class="content">
      <div class="box box-success">
            <div class="box-header with-border">
              <h3 class="box-title">Grafik Luas Cagar Alam</h3>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Tabel Luas Cagar Alam</h3>
              <!-- <div class="box-tools">
                ...
                <tbody>
                  @foreach($luas_hutans as $luas_hutan)
                    <tr>
                      ...
                      <td>
                        <form action="/cagar_alam/{{$luas_hutan->id}}" method="post">
                          <a class="btn btn-round btn-info btn-xs" href="/cagar_alam/{{$luas_hutan->id}}/edit">Edit</a>
