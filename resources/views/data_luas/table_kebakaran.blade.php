...
<!-- Content Header (Page header) -->
    <section class="content-header">
      ...
      <br>
      <button type="button" class="btn btn-primary btn-s" onclick="location.href='{{url('/data_luas_kebakaran/create')}}'">Tambah</button>
      <a href="{{ route('data_luas.excel_kebakaran') }}" class="btn btn-success btn-s">Export ke Excel</a>     
    </section>
    ...
    <section class="content">
      <div class="box box-success">
            <div class="box-header with-border">
              <h3 class="box-title">Grafik Luas Kebakaran</h3>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Tabel Data Luas Kebakaran</h3>
              <div class="box-tools">
                ...
                <tbody>
                  @foreach($data_luas as $key)
                    <tr>
                      ...
                      <td>{{ $key->luas }}</td>
                      <td>
                        <form action="/data_luas_kebakaran/{{$key->id}}" method="post">
                          <a class="btn btn-round btn-info btn-xs" href="/data_luas_kebakaran/{{$key->id}}/edit">Edit</a>
      ...
      for(let i = 0; i < list.length; i++){
        ...
        for(let j = 0; j < tahun.length; j++){
          ...
          if(tahun_obj != tahun[j]){
            ...
            data['data'].push( list[i]['luas'][k]['luass']);
            k++;
          }
        }
        datas.push(data);
