...
@section('title', 'Suaka Margasatwa')
...
<!-- Content Header (Page header) -->
    <section class="content-header">
      ...
      <br>
      <button type="button" class="btn btn-primary btn-s" onclick="location.href='{{url('/suaka_margasatwa/create')}}'">Tambah</button>
      <a href="{{ route('suaka_margasatwa.excel') }}" class="btn btn-success btn-s">Export ke Excel</a>
    </section>
  <!-- Main content -->
    <section class="content">
      <div class="box box-success">
            <div class="box-header with-border">
              <h3 class="box-title">Grafik Luas Suaka Margasatwa</h3>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Tabel Luas Suaka Margasatwa</h3>
              <!-- <div class="box-tools">
                ...
                <tbody>
                  @foreach($luas_hutans as $luas_hutan)
                    <tr>
                      ...
                      <td>
                        <form action="/suaka_margasatwa/{{$luas_hutan->id}}" method="post">
                          <a class="btn btn-round btn-info btn-xs" href="/suaka_margasatwa/{{$luas_hutan->id}}/edit">Edit</a>
  ...
  <script type="text/javascript">
    ...
    Highcharts.chart('container', {
              title: {
                text: 'Data Luas Suaka Margasatwa'
              },
              chart: {
                  type: 'area'
              },
