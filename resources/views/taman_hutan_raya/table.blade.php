...
@section('title', 'Taman Hutan Raya')
...
<!-- Content Header (Page header) -->
    <section class="content-header">
      ...
      <br>
      <button type="button" class="btn btn-primary btn-s" onclick="location.href='{{url('/taman_hutan_raya/create')}}'">Tambah</button>
      <a href="{{ route('taman_hutan_raya.excel') }}" class="btn btn-success btn-s">Export ke Excel</a>
    </section>
  <!-- Main content -->
    <section class="content">
      <div class="box box-success">
            <div class="box-header with-border">
              <h3 class="box-title">Grafik Luas Taman Hutan Raya</h3>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Tabel Luas Taman Hutan Raya</h3>
              <!-- <div class="box-tools">
                ...
                <tbody>
                  @foreach($luas_hutans as $luas_hutan)
                    <tr>
                      ...
                      <td>
                        <form action="/taman_hutan_raya/{{$luas_hutan->id}}" method="post">
                          <a class="btn btn-round btn-info btn-xs" href="/taman_hutan_raya/{{$luas_hutan->id}}/edit">Edit</a>
  ...
  <script type="text/javascript">
    ...
    Highcharts.chart('container', {
              title: {
                text: 'Data Luas Taman Hutan Raya'
              },
              chart: {
                  type: 'area'
              },
